...
const HomeLandingPage = () => {
  ...
  const getCoverSrc = (_title: string, fallbackSrc: string) => fallbackSrc || onlineImageFallback;
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {editorsPick.length === 0 ? (
              <div className="col-span-full rounded-xl border border-border bg-background p-6 text-sm text-muted-foreground">
                Live topic picks are unavailable right now.
              </div>
            ) : (
              ...
              <div className="space-y-3">
                {mostReadItems.length === 0 ? (
                  <p className="rounded-lg border border-border p-3 text-sm text-muted-foreground">
                    Most Read is unavailable until live trends are loaded.
                  </p>
                ) : (
            ...
            >
              ...
              <div className="space-y-3">
                {mostLikedItems.length === 0 ? (
                  <p className="rounded-lg border border-border p-3 text-sm text-muted-foreground">
                    Most Liked is unavailable until live trends are loaded.
                  </p>
                ) : (
